				...
				<div className="col-lg-12 col-md-12 col-12">
					<div className="border-bottom pb-3 mb-3 d-flex justify-content-between align-items-center">
						...
						<div className="nav btn-group" role="tablist">
							<div className='me-2'>
								<Link href="/admin/competitions/competitions-add" className="btn btn-outline-secondary" data-bs-target="#newCatgory" alt="">إضافة مسابقة جديدة</Link>
							</div>
						</div>
					</div>
				</div>
