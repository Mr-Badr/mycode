                ...
                >
                  <div className="simplebar-content" style={{ padding: "0px" }}>
                    ...
                    لوحة التحكم
                      ...
                      {/* Formations */}
                      {/* <li className="nav-item">
                        <Link href="/admin/formations" className={pathname === '/admin/formations' ? 'nav-link active nav-link  collapsed tajawal-medium' : 'nav-link nav-link  collapsed tajawal-medium'}>
                      ...
                      {/* Levels */}
                      <li className="nav-item">
                        <Link href="/admin/levels" className={pathname === '/admin/levels' ? 'nav-link active nav-link  collapsed tajawal-medium' : 'nav-link nav-link  collapsed tajawal-medium'}>
                      ...
                      <li className="nav-item">
                        ...
                        <div
                          id="navProfile"
                          className={pathname === '/admin/teachers' | pathname === "/admin/add-teacher" ? 'collapse  show ' : 'collapse'}
                      ...
                      {/* <li className="nav-item">
                        <a
                          ...
                          href="#"
                          data-bs-toggle="collapse"
                          data-bs-target="#navsubject"
                          aria-expanded="false"
                          aria-controls="navsubject"
                        >
                          <i className="fe fe-grid nav-icon me-2"></i>
                          المواد الدراسية 
                        </a>
                        <div
                          id="navsubject"
                          data-bs-parent="#sideNavbar"
                          className={pathname === '/admin/subjects' || pathname === '/admin/subjects-add' ? 'collapse  show ' : 'collapse'}
                        >
                          <ul className="nav flex-column">
                            <li className="nav-item">
                              <Link href="/admin/subjects" className={pathname === '/admin/subjects' ? 'nav-link active' : 'nav-link'}>
                                جميع المواد الدراسية 
                              </Link>
                            </li>
                            <li className="nav-item">
                              <Link href="/admin/subjects-add" className={pathname === '/admin/subjects-add' ? 'nav-link active' : 'nav-link'}>
                                إضافة مادة دراسية
                              </Link>
                            </li>
                          </ul>
...
<li className="nav-item">
                        ...
                        <div
                          id="navcomp"
                          data-bs-parent="#sideNavbar"
                          className={pathname === '/admin/formations' || pathname === '/admin/formations/add-formations' ? 'collapse  show ' : 'collapse'}
                        >
                          <ul className="nav flex-column">
                            <li className="nav-item">
                              <Link href="/admin/formations" className={pathname === '/admin/formations' ? 'nav-link active' : 'nav-link'}>
                                جميع الدورات
                              </Link>
                            </li>
                            <li className="nav-item">
                              <Link href="/admin/formations/add-formations" className={pathname === '/admin/formations/add-formations' ? 'nav-link active' : 'nav-link'}>
                                إضافة دورة
                              </Link>
                            </li>
                          </ul>
